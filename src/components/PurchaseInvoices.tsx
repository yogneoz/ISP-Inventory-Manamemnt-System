    ...
    <div className="space-y-6">
        ...
        <div className="flex items-center gap-3">
          <div className="relative">
            ...
            <input
              ...
              className="pl-9 pr-3 py-2 text-xs rounded-xl border border-slate-200 bg-white text-slate-800 focus:outline-none focus:ring-2 focus:ring-blue-500 w-44 sm:w-64 shadow-xs"
            />
          </div>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
        <div className="rounded-2xl bg-white p-4 border border-slate-200 shadow-xs">
          <span className="text-xs font-semibold text-slate-500">Taxable Purchases</span>
        ...
        <div className="rounded-2xl bg-white p-4 border border-blue-200 bg-blue-50/20 shadow-xs">
          <span className="text-xs font-semibold text-blue-700">13% Input VAT</span>
          <div className="text-lg font-mono font-extrabold text-blue-600 mt-1">
        ...
        <div className="rounded-2xl bg-white p-4 border border-amber-200 bg-amber-50/20 shadow-xs">
          <span className="text-xs font-semibold text-amber-700">Vendor Credit Payable</span>
          <div className="text-lg font-mono font-extrabold text-amber-600 mt-1">
