  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          <h2 className="text-xl font-serif font-bold text-slate-900 dark:text-white tracking-tight flex items-center gap-2">
        ...
        <div className="flex items-center gap-3">
          <div className="relative">
            ...
            <input
              ...
              className="pl-9 pr-3 py-2 text-xs rounded-xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-[#0f1218] text-slate-800 dark:text-slate-200 focus:outline-none focus:ring-2 focus:ring-indigo-500 w-48 sm:w-64"
            />
          </div>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
        <div className="rounded-2xl bg-white dark:bg-[#0f1218] p-4 border border-slate-200 dark:border-slate-800 shadow-sm">
        ...
        <div className="rounded-2xl bg-white dark:bg-[#0f1218] p-4 border border-amber-500/30 bg-amber-500/5 shadow-sm">
        ...
        <div className="rounded-2xl bg-white dark:bg-[#0f1218] p-4 border border-emerald-500/30 bg-emerald-500/5 shadow-sm">
        ...
        <div className="rounded-2xl bg-white dark:bg-[#0f1218] p-4 border border-indigo-500/30 bg-indigo-500/5 shadow-sm">
      ...
      {/* Shipment Table */}
      <div className="rounded-2xl bg-white dark:bg-[#0f1218] border border-slate-200 dark:border-slate-800 shadow-xl overflow-hidden">
        <div className="overflow-x-auto">
          <table className="w-full text-left text-xs">
            <thead className="bg-slate-50 dark:bg-slate-900/50 text-slate-500 font-bold uppercase text-[10px] tracking-wider border-b border-slate-200 dark:border-slate-800">
              <tr>
                <th className="p-3.5">Tracking Code</th>
                <th className="p-3.5">Shipment Type</th>
                <th className="p-3.5">From (Source)</th>
