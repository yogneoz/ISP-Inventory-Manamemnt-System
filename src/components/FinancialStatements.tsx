          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            >
              ...
              <p className="text-2xl font-bold font-mono text-emerald-500">
                NPR {totalAssets.toLocaleString()}
              </p>
              <p className="text-[11px] text-slate-400 mt-1">
                Inventory (NPR {inventoryAssetVal.toLocaleString()}) + Fixed Assets (NPR {fixedAssetNBV.toLocaleString()})
              </p>
            </div>
            ...
            >
              ...
              <p className="text-2xl font-bold font-mono text-amber-500">
                NPR {totalLiabilities.toLocaleString()}
              </p>
              <p className="text-[11px] text-slate-400 mt-1">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            >
              <div className="flex items-center justify-between border-b border-slate-200 dark:border-slate-800 pb-3">
                ...
                <span className="text-xs font-mono font-bold text-slate-400">NPR {totalAssets.toLocaleString()}</span>
              </div>
              ...
              <div className="space-y-3 text-xs">
                ...
                <div className="flex justify-between items-center py-1.5 border-b border-slate-100 dark:border-slate-800/60">
                  ...
                  <span className="font-mono font-semibold">NPR {inventoryAssetVal.toLocaleString()}</span>
                </div>
                ...
                <div className="flex justify-between items-center py-1.5 border-b border-slate-100 dark:border-slate-800/60">
                  ...
                  <span className="font-mono font-semibold">NPR {fixedAssetNBV.toLocaleString()}</span>
                </div>
                <div className="flex justify-between items-center py-1 text-slate-400 text-[11px] pl-3">
                  ...
                  <span className="font-mono">NPR {(assets || []).reduce((sum, a) => sum + (a.acquisitionCost ?? 0), 0).toLocaleString()}</span>
                </div>
                <div className="flex justify-between items-center py-1 text-slate-400 text-[11px] pl-3">
                  <span>Less: Accumulated Depreciation</span>
                  <span className="font-mono text-rose-500">
                    - NPR {(assets || []).reduce((sum, a) => sum + (a.accumulatedDepreciation ?? 0), 0).toLocaleString()}
                  </span>
                </div>
              </div>
              ...
              <div className="pt-3 border-t border-slate-200 dark:border-slate-800 flex justify-between items-center font-bold text-sm">
                <span>TOTAL ASSETS</span>
                <span className="font-mono text-emerald-500">NPR {totalAssets.toLocaleString()}</span>
              </div>
            </div>
            ...
            >
              ...
              <div className="space-y-3 text-xs">
                ...
                <div className="flex justify-between items-center py-1.5 border-b border-slate-100 dark:border-slate-800/60">
                  ...
                  <span className="font-mono font-semibold text-amber-500">NPR {accountsPayable.toLocaleString()}</span>
                </div>
                ...
                <div className="flex justify-between items-center py-1.5 border-b border-slate-100 dark:border-slate-800/60">
                  ...
                  <span className="font-mono font-semibold">NPR {netEquity.toLocaleString()}</span>
                </div>
              </div>

              <div className="pt-3 border-t border-slate-200 dark:border-slate-800 flex justify-between items-center font-bold text-sm">
                <span>TOTAL LIABILITIES & EQUITY</span>
                <span className="font-mono text-indigo-500">NPR {(totalLiabilities + netEquity).toLocaleString()}</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            >
              ...
              <p className="text-2xl font-bold font-mono text-emerald-500">
                NPR {netRevenue.toLocaleString()}
              </p>
              <p className="text-[11px] text-slate-400 mt-1">
                Purchase Total (NPR {grossPurchaseValue.toLocaleString()}) + Discounts
              </p>
            </div>
            ...
            >
              ...
              <p className="text-2xl font-bold font-mono text-rose-500">
                NPR {operatingExpenses.toLocaleString()}
              </p>
              <p className="text-[11px] text-slate-400 mt-1">
          ...
          >
            ...
            <div className="space-y-3 text-xs">
              <div className="flex justify-between items-center py-2 border-b border-slate-100 dark:border-slate-800/80 font-medium">
                ...
                <span className="font-mono">NPR {grossPurchaseValue.toLocaleString()}</span>
              </div>
              ...
              <div className="flex justify-between items-center py-2 border-b border-slate-100 dark:border-slate-800/80 text-emerald-600 dark:text-emerald-400">
                ...
                <span className="font-mono">+ NPR {totalDiscountReceived.toLocaleString()}</span>
              </div>
              ...
              <div className="flex justify-between items-center py-2.5 border-b border-slate-200 dark:border-slate-800 font-bold text-slate-900 dark:text-white">
                ...
                <span className="font-mono">NPR {netRevenue.toLocaleString()}</span>
              </div>
              ...
              <div className="flex justify-between items-center py-2 border-b border-slate-100 dark:border-slate-800/80 text-rose-500">
                ...
                <span className="font-mono">- NPR {operatingExpenses.toLocaleString()}</span>
              </div>
              ...
              <div className="flex justify-between items-center py-3 border-t-2 border-indigo-500 font-bold text-base text-indigo-600 dark:text-indigo-400">
                ...
                <span className="font-mono">NPR {netProfit.toLocaleString()}</span>
              </div>
            </div>
          </div>
        </div>
