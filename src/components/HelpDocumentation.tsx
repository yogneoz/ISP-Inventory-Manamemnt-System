  ...
  const workflows: ProcessWorkflow[] = [
    ...
    },
    {
      ...
      steps: [
        ...
        {
          step: 3,
          title: 'Initiate Device Replacement / Refund',
          role: 'Front Desk / Technician',
          description: 'Log defective device return or refund request with defect notes.',
          actionTab: 'customer-devices',
          keyOutputs: ['Approval Request Generated', 'Device Flagged SUSPENDED'],
        },
        {
          step: 4,
          title: 'Approval & Restock Action',
          role: 'Branch Manager / Super Admin',
          description: 'Manager approves replacement. System automatically returns good hardware to store stock.',
          actionTab: 'approvals',
          keyOutputs: ['Updated Customer Status', 'Restocked Hardware Ledger'],
        },
      ],
    },
    {
